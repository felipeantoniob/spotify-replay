...
const Layout = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <>
      ...
      <div className="h-screen w-screen bg-purple-gradient bg-cover fixed" />
      <div className="relative">
        {ROUTES_WITH_NAVBAR.includes(router.pathname) && <MobileNavbar />}
        <main className="pt-8 z-10">
